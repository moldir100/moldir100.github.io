...
const model = ref([

    {
        ...
        items: [
            { label: 'Кабинет энергопредприятия',  icon: 'pi pi-fw pi-id-card', to: '/profile/dashboard', src: '../src/assets/icons/sidebar/1.png' },
            ...
            { label: 'Согласование планов ремонтов', icon: 'pi pi-fw pi-id-card', to: '/repairPlan', src: '../src/assets/icons/sidebar/4.png'},
